const STAGE_TRACKER_STORAGE_KEY = 'docai_document_stage_tracker'
...
function loadStageTracker() {
  const value = wx.getStorageSync(STAGE_TRACKER_STORAGE_KEY) || {}
  return value && typeof value === 'object' ? value : {}
}

function saveStageTracker(tracker) {
  wx.setStorageSync(STAGE_TRACKER_STORAGE_KEY, tracker && typeof tracker === 'object' ? tracker : {})
}
