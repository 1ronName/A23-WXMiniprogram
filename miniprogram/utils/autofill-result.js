const STORAGE_KEY = 'docai_autofill_results'
...
function normalizeAutofillResult(record) {
  ...
  const outputName = normalizeText(record && (record.outputName || record.fileName))
...
function saveRecords(list) {
  ...
  wx.setStorageSync(STORAGE_KEY, normalizedList)
